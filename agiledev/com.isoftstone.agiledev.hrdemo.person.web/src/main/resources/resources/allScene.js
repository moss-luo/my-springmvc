...
$(function(){
	...
	var options = {
		removeUrl : 'mvc/person/delete.json',
		saveUrl : 'mvc/person/add.json',
		updateUrl : 'mvc/person/modify.json',
		grid:{
			dataUrl : 'mvc/person/query',
			idField : 'id',
			pageSize : 10,
...
function viewItem(id){
	...
	$.ajax({
		type: "POST",
		   url:'mvc/person/viewPerson.json',
		   dataType:'json',
		   data:{id:id},
